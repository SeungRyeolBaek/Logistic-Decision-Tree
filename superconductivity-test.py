...
from LogisticSplitDecisionTree import LogisticDecisionTreeRegressor, plot_decision_tree
...
X = data.drop(columns=['critical_temp'])  # Use all columns except 'critical_temp' as features
y = data['critical_temp']  # Target column
...
for depth in max_depth_list:
    ...
    plt.tight_layout()
    plt.savefig(f'superconductivity-result/comparison_regression_depth_{depth}.png')
    plt.close()
